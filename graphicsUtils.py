...
_root_window = None			# The root of window
_canvas = None				# The canvas which holds graphics
_canvas_xs = None			# Size of canvas object
_canvas_ys = None			
_canvas_x = None			# Current position on canvas
_canvas_ys = None
_canvas_col = None			# Current colour
_canvas_tsize = 12
_canvas_tserifs = 0

# format the color. e.g. rgb(1,1,1)-> #ffffff
def formatColor(r, g, b):
	return '#%02x%02x%02x' % (int(r * 255), int(g * 255), int(b * 255))

# Color to Vector e.g. "#ffffff" -> [0.99609375, 0.99609375, 0.99609375]
...
def end_graphics():
	global _root_window, _canvas, _mouse_enables
	try:
		try:
			sleep(1)
			if _root_window != None:
